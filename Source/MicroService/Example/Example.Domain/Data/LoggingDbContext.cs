...
namespace Example.Domain.Data
{
    public class LoggingDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // RequestDataModel mapping
            modelBuilder.Entity<RequestDataModel>(entity =>
            {
                entity.ToTable("request_logs", "error");
                entity.HasKey(e => e.request_id);

                // UUID column (no UseSerialColumn, Postgres sequences only work with integers)
                entity.Property(e => e.request_id)
                      .HasColumnName("id")
                      .HasColumnType("uuid")
                      .HasDefaultValueSql("gen_random_uuid()"); // PostgreSQL function to auto-generate UUID
                ...
                entity.Property(e => e.entity_rand_id)
